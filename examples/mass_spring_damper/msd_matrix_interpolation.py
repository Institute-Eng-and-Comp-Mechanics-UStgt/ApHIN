...
def phin_learning(msd_data, msd_cfg, config_dirs):
...
def main(config_path_to_file=None):
    ...
    for i_same_mu_scenario in range(num_train_scenarios_with_same_mu):
        ...
        msd_data_id, system_layer, phin = phin_learning(
            msd_data, msd_cfg, configuration.directories
        )
        scenario_list.append((msd_data_id, system_layer, phin, msd_data))
