...
with open(
    os.path.join(
        os.path.dirname(__file__), "config_msd_matrix_interpolation_data_gen.yml"
    ),
    "r",
) as file:
...
system_types = ["ph", "ss"]
Q_id_bools = [True, False]
msd_list = []
for system_type in system_types:
    for Q_id_bool in Q_id_bools:
        ...
        msd.save(save_name_suffix="matrix_interpolation")
        msd_list.append(msd)
