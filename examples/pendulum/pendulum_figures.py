...
def main():
    ...
    experiments = {
        "reference": Experiment(file_path="pendulum_model_aphin_linear/reference.csv", linestyle="solid", color="black"),
        "phin": Experiment(file_path="pendulum_model_phin/phin.csv", linestyle="dashdot", color="cyan"),
        "aphin_linear": Experiment(file_path="pendulum_model_aphin_linear/aphin_linear.csv", linestyle="dotted", color="purple"),
        "aphin_nonlinear": Experiment(file_path="pendulum_model_aphin_nonlinear/aphin_nonlinear.csv", linestyle="dashed", color="magenta"),
    }
